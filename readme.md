...
- [Step 2: Obtain Philips username](#step-2)
- [Step 3: Create the server](#step-3)
- [Step 4: Port forward your Raspberry Pi](#step-4)
- [Step 5: Transfer server to Raspberry Pi](#step-5)
- [Step 6: Run the server](#step-6)
- [Step 7: Create the client and deploy](#step-7)

# Links

- App [Github pages](https://ojself.github.io/hueBlinkClient/)
- Client [repository](https://github.com/Ojself/hueBlinkClient)- Server [repository](https://github.com/Ojself/hueBlinkClient)
